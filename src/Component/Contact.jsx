                    ...
                    <div class="footer-content">
                            ...
                            <div class="footer-menu">
                                ...
                                <ul id="menu-get-started" class="footer-menu-list">
                                    <li class="menu-item menu-item-type-post_type menu-item-object-product">
                                        <a href="#">Dhungedhara, Vanasthali</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="footer-menu">
                                ...
                                <ul id="menu-quick-links" class="footer-menu-list">
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom">
                                        <a target="_blank" rel="noopener noreferrer" href="#">yatrainfosys@gmail.com</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="footer-content-column">
                            ...
                            <div class="footer-call-to-action">
                                ...
                                <p class="footer-call-to-action-link-wrapper"> <a class="footer-call-to-action-link" href="tel:0124-64XXXX" target="_self"> <p className='conttext'>+977-9818044464,</p>
                    ...
                    <div class="footer-copyright">
                        <div class="footer-copyright-wrapper">
                            <p class="footer-copyright-text">
                                <a class="footer-copyright-link" href="#" target="_self"> ©2023. | Designed By: Yatra Info Sys. | All rights reserved. </a>
                            </p>
                        </div>
                    </div>
                </footer>
